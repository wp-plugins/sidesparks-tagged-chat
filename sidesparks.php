...
$tagged_root = "http://tagged.sidesparks.com";
$maxtagged_root = "http://maxtagged.sidesparks.com";
...
*/
add_action('get_footer', 'displaySidesparks');
function displaySidesparks()
{
    $browser = new browser();
    global $show_on_main_page, $show_on_category, $tagged_root, $maxtagged_root, $timeOffset;
?>
<style>
div#sidesparks_head_top {
  ...
  position: absolute;
  z-index: 40;
  background:url("<? echo $tagged_root; ?>/themes/sidesparks/images/tagged_box_top.png");
}
...
div#sidesparks_head_left {
  ...
  position: absolute;
  z-index: 40;
  background:url("<? echo $tagged_root; ?>/themes/sidesparks/images/tagged_box_left.png");
}
...
div#sidesparks_head_right {
  ...
  position: absolute;
  z-index: 40;
  background:url("<? echo $tagged_root; ?>/themes/sidesparks/images/tagged_box_right.png");
}
...
div#sidesparks_head_top_left {
  ...
  position: absolute;
  z-index: 41;
  background:url("<? echo $tagged_root; ?>/themes/sidesparks/images/tagged_box_top_left.png");
}
...
div#sidesparks_head_top_right {
  ...
  position: absolute;
  z-index: 41;
  background:url("<? echo $tagged_root; ?>/themes/sidesparks/images/tagged_box_top_right.png");
}
...
div#sidesparks_close {
  background-image:url('<? echo $tagged_root; ?>/themes/sidesparks/images/x.jpg');
  position: absolute;
  right: 10px;
  top: 10px;
  width: 20px;
...
div#sidesparks_maximize {
  background-image:url('<? echo $tagged_root; ?>/themes/sidesparks/images/max.jpg');
  position: absolute;
  right: 35px;
  top: 10px;
  width: 19px;
...
<div id = "sidesparks_window" style = "position: fixed; top: 50px; left: 25%; display: none; background-color: transparent;">
  <div id = "sidesparks_head" id = "sidesparks_head" style = "background-color: transparent;">
    ...
    <div id = "sidesparks_head_logo"><a href = "http://www.sidesparks.com" target = "_BLANK"><img id = "sidesparks_logo" src = "<? echo $tagged_root; ?>/themes/sidesparks/images/header_logo.jpg" style = "border: 0px;"></a></div>
  ...
  <div id = "sidesparks_loading_overlay" style = "width: 100%; height: 100%; display: none; position: absolute; top: 42px; left: 1px;"><img src = "<? echo $tagged_root; ?>/themes/sidesparks/images/loading_image.png" /></div>
</div>
<script>
...
if(($browser->Name == 'MSIE' && $browserMajorVersion == "6") == false) { ?>
      var url = '<? echo $tagged_root; ?>/gate.php?domain=' + escape(document.location.href) + '&logo_url=' + escape(sidesparks_logo_url) + '&background_top=' + escape(sidesparks_background_top)
...
<? if($browser->Name == 'MSIE') {?>
      document.getElementById('sidesparks_window').style.display = "";
      setTimeout('document.getElementById("sidesparks_iframe").style.display = "";', 5000);
      setTimeout('document.getElementById("sidesparks_loading_overlay").style.display = "none";', 5000);
<? }else{ ?>
...
<? } ?>
  ...
  function maximizeSidesparks()
  {
      ...
      var url = '<? echo $maxtagged_root; ?>/gate.php?domain=' + escape(document.location.href) + '&logo_url=' + escape(sidesparks_logo_url) + '&background_top=' + escape(sidesparks_background_top)
